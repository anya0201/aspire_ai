# aspire PRD: Your AI-Powered Personal Learning Website
...
**Core thesis:** Every learner deserves a personal learning website that adapts to them, not a generic SaaS dashboard they rent. aspire runs locally, ingests any course material (PDFs, slides, Canvas LMS), and builds an AI-powered learning space that evolves with you.
...
- **vs. Hyperknow:** Same core logic (agent-based learning), but aspire is locally deployed, open-source, and gives users full data ownership. No subscription lock-in.
- **vs. Knowt/Quizlet:** Beyond flashcards. aspire builds a knowledge graph (LOOM), does semantic spaced repetition (LECTOR), and provides an autonomous agent — not just content generation.
- **vs. Anki:** Anki is a flashcard tool. aspire is a complete learning environment with notes, practice, knowledge graphs, study plans, and an AI tutor.
