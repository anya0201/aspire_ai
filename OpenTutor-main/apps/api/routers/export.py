...
async def export_session(
    ...
    return StreamingResponse(
        ...
        media_type="text/csv",
        headers={"Content-Disposition": "attachment; filename=aspire-session-export.csv"},
    )
...
async def export_anki(
    ...
    course_name = course_result.scalar() or "aspire"
