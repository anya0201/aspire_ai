#!/usr/bin/env bash
# aspire — One-line install script
# Usage: curl -sSL https://raw.githubusercontent.com/zijinz456/aspire/main/scripts/install.sh | bash
set -euo pipefail

REPO_URL="https://github.com/zijinz456/aspire.git"
INSTALL_DIR="${aspire_DIR:-$HOME/aspire}"
...
if [ -d "$INSTALL_DIR/.git" ]; then
    ...
    info "Cloning aspire to $INSTALL_DIR..."
