 ...
 *   - Sidebar with aspire branding, Home, and Settings navigation
...
test.describe("Dashboard", () => {
  ...
  test("renders header with aspire branding", async ({ page }) => {
    await page.goto("/");
    await expect(page.getByText("aspire").first()).toBeVisible({ timeout: 15_000 });
  });
