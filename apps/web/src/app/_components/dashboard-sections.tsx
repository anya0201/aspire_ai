...
export function WeeklyStatsSection({ weeklyReport }: { weeklyReport: WeeklyReport | null }) {
  ...
  return (
    <DashSection title="Weekly Learning Statistics" icon={TrendingUp}>
      <div className="grid grid-cols-3 gap-3">
        <div className="rounded-xl bg-muted/30 p-3.5 flex flex-col gap-1">
          <p className="text-[11px] text-muted-foreground">Learning Duration</p>
          <p className="text-lg font-bold text-foreground tabular-nums">{this_week.study_minutes}<span className="text-xs font-normal text-muted-foreground ml-0.5">Minutes</span></p>
          {delta(deltas.study_minutes, "min")}
          <p className="text-[10px] text-muted-foreground">Last week {last_week.study_minutes} Minutes</p>
        </div>
        <div className="rounded-xl bg-muted/30 p-3.5 flex flex-col gap-1">
        ...
        <div className="rounded-xl bg-muted/30 p-3.5 flex flex-col gap-1">
          ...
          <p className="text-lg font-bold text-foreground tabular-nums">{this_week.active_days}<span className="text-xs font-normal text-muted-foreground ml-0.5">days</span></p>
          <p className="text-[10px] text-muted-foreground">Last week {last_week.active_days} days</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-xl bg-muted/30 p-3.5">
            ...
            <p className="text-xl font-bold text-foreground tabular-nums">
              {masteryOverview.total_study_minutes}<span className="text-xs font-normal text-muted-foreground ml-0.5">Minutes</span>
            </p>
          </div>
        </div>
        <div className="space-y-2">
