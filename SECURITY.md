...
If you discover a security vulnerability in aspire, please report it responsibly:
...
- **Never expose Aspire to the public internet without authentication enabled.**
